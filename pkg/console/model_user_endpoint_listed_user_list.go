...
// checks if the UserEndpointListedUserList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserEndpointListedUserList{}

// UserEndpointListedUserList struct for UserEndpointListedUserList
type UserEndpointListedUserList struct {
...
type _UserEndpointListedUserList UserEndpointListedUserList
...
func NewUserEndpointListedUserList(first bool, hasNext bool, hasPrevious bool, items []ListedUser, last bool, page int32, size int32, total int64, totalPages int64) *UserEndpointListedUserList {
	this := UserEndpointListedUserList{}
	this.First = first
...
func (o UserEndpointListedUserList) MarshalJSON() ([]byte, error) {
...
func (o UserEndpointListedUserList) ToMap() (map[string]interface{}, error) {
...
func (o *UserEndpointListedUserList) UnmarshalJSON(data []byte) (err error) {
	...
	varUserEndpointListedUserList := _UserEndpointListedUserList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserEndpointListedUserList)

	if err != nil {
		return err
	}

	*o = UserEndpointListedUserList(varUserEndpointListedUserList)

	return err
}

type NullableUserEndpointListedUserList struct {
	value *UserEndpointListedUserList
	isSet bool
}

func (v NullableUserEndpointListedUserList) Get() *UserEndpointListedUserList {
	return v.value
}

func (v *NullableUserEndpointListedUserList) Set(val *UserEndpointListedUserList) {
	v.value = val
	v.isSet = true
}

func (v NullableUserEndpointListedUserList) IsSet() bool {
	return v.isSet
}

func (v *NullableUserEndpointListedUserList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserEndpointListedUserList(val *UserEndpointListedUserList) *NullableUserEndpointListedUserList {
	return &NullableUserEndpointListedUserList{value: val, isSet: true}
}

func (v NullableUserEndpointListedUserList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserEndpointListedUserList) UnmarshalJSON(src []byte) error {
	v.isSet = true
