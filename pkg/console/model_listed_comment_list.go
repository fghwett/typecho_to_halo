...
// checks if the ListedCommentList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListedCommentList{}

// ListedCommentList struct for ListedCommentList
type ListedCommentList struct {
	...
	// A chunk of items.
	Items []ListedComment `json:"items"`
...
type _ListedCommentList ListedCommentList
...
func (o ListedCommentList) MarshalJSON() ([]byte, error) {
...
func (o ListedCommentList) ToMap() (map[string]interface{}, error) {
...
func (o *ListedCommentList) UnmarshalJSON(data []byte) (err error) {
	...
	varListedCommentList := _ListedCommentList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListedCommentList)

	if err != nil {
		return err
	}

	*o = ListedCommentList(varListedCommentList)

	return err
}

type NullableListedCommentList struct {
	value *ListedCommentList
	isSet bool
}

func (v NullableListedCommentList) Get() *ListedCommentList {
	return v.value
}

func (v *NullableListedCommentList) Set(val *ListedCommentList) {
	v.value = val
	v.isSet = true
}

func (v NullableListedCommentList) IsSet() bool {
	return v.isSet
}

func (v *NullableListedCommentList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListedCommentList(val *ListedCommentList) *NullableListedCommentList {
	return &NullableListedCommentList{value: val, isSet: true}
}

func (v NullableListedCommentList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListedCommentList) UnmarshalJSON(src []byte) error {
	v.isSet = true
