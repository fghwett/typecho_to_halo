...
// checks if the ListedSinglePageVoList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListedSinglePageVoList{}

// ListedSinglePageVoList struct for ListedSinglePageVoList
type ListedSinglePageVoList struct {
	...
	// A chunk of items.
	Items []ListedSinglePageVo `json:"items"`
...
type _ListedSinglePageVoList ListedSinglePageVoList
...
func (o ListedSinglePageVoList) MarshalJSON() ([]byte, error) {
...
func (o ListedSinglePageVoList) ToMap() (map[string]interface{}, error) {
...
func (o *ListedSinglePageVoList) UnmarshalJSON(data []byte) (err error) {
	...
	varListedSinglePageVoList := _ListedSinglePageVoList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListedSinglePageVoList)

	if err != nil {
		return err
	}

	*o = ListedSinglePageVoList(varListedSinglePageVoList)

	return err
}

type NullableListedSinglePageVoList struct {
	value *ListedSinglePageVoList
	isSet bool
}

func (v NullableListedSinglePageVoList) Get() *ListedSinglePageVoList {
	return v.value
}

func (v *NullableListedSinglePageVoList) Set(val *ListedSinglePageVoList) {
	v.value = val
	v.isSet = true
}

func (v NullableListedSinglePageVoList) IsSet() bool {
	return v.isSet
}

func (v *NullableListedSinglePageVoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListedSinglePageVoList(val *ListedSinglePageVoList) *NullableListedSinglePageVoList {
	return &NullableListedSinglePageVoList{value: val, isSet: true}
}

func (v NullableListedSinglePageVoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListedSinglePageVoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
