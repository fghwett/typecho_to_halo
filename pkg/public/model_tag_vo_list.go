...
// checks if the TagVoList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagVoList{}

// TagVoList struct for TagVoList
type TagVoList struct {
...
func (o TagVoList) MarshalJSON() ([]byte, error) {
...
func (o TagVoList) ToMap() (map[string]interface{}, error) {
...
func (o *TagVoList) UnmarshalJSON(data []byte) (err error) {
	...
	varTagVoList := _TagVoList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTagVoList)

	if err != nil {
		return err
	}

	*o = TagVoList(varTagVoList)

	return err
}

type NullableTagVoList struct {
	value *TagVoList
	isSet bool
}

func (v NullableTagVoList) Get() *TagVoList {
	return v.value
}

func (v *NullableTagVoList) Set(val *TagVoList) {
	v.value = val
	v.isSet = true
}

func (v NullableTagVoList) IsSet() bool {
	return v.isSet
}

func (v *NullableTagVoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagVoList(val *TagVoList) *NullableTagVoList {
	return &NullableTagVoList{value: val, isSet: true}
}

func (v NullableTagVoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagVoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
