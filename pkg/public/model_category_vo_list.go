...
// checks if the CategoryVoList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoryVoList{}

// CategoryVoList struct for CategoryVoList
...
type _CategoryVoList CategoryVoList
...
func (o CategoryVoList) MarshalJSON() ([]byte, error) {
...
func (o CategoryVoList) ToMap() (map[string]interface{}, error) {
...
func (o *CategoryVoList) UnmarshalJSON(data []byte) (err error) {
	...
	varCategoryVoList := _CategoryVoList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCategoryVoList)

	if err != nil {
		return err
	}

	*o = CategoryVoList(varCategoryVoList)

	return err
}

type NullableCategoryVoList struct {
	value *CategoryVoList
	isSet bool
}

func (v NullableCategoryVoList) Get() *CategoryVoList {
	return v.value
}

func (v *NullableCategoryVoList) Set(val *CategoryVoList) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoryVoList) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoryVoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoryVoList(val *CategoryVoList) *NullableCategoryVoList {
	return &NullableCategoryVoList{value: val, isSet: true}
}

func (v NullableCategoryVoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCategoryVoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
