...
// checks if the CommentVoList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommentVoList{}

// CommentVoList struct for CommentVoList
type CommentVoList struct {
...
type _CommentVoList CommentVoList
...
func (o CommentVoList) MarshalJSON() ([]byte, error) {
...
func (o CommentVoList) ToMap() (map[string]interface{}, error) {
...
func (o *CommentVoList) UnmarshalJSON(data []byte) (err error) {
	...
	varCommentVoList := _CommentVoList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommentVoList)

	if err != nil {
		return err
	}

	*o = CommentVoList(varCommentVoList)

	return err
}

type NullableCommentVoList struct {
	value *CommentVoList
	isSet bool
}

func (v NullableCommentVoList) Get() *CommentVoList {
	return v.value
}

func (v *NullableCommentVoList) Set(val *CommentVoList) {
	v.value = val
	v.isSet = true
}

func (v NullableCommentVoList) IsSet() bool {
	return v.isSet
}

func (v *NullableCommentVoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommentVoList(val *CommentVoList) *NullableCommentVoList {
	return &NullableCommentVoList{value: val, isSet: true}
}

func (v NullableCommentVoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommentVoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
