...
// checks if the ListedPostVoList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListedPostVoList{}

// ListedPostVoList struct for ListedPostVoList
type ListedPostVoList struct {
...
type _ListedPostVoList ListedPostVoList
...
func (o ListedPostVoList) MarshalJSON() ([]byte, error) {
...
func (o ListedPostVoList) ToMap() (map[string]interface{}, error) {
...
func (o *ListedPostVoList) UnmarshalJSON(data []byte) (err error) {
	...
	varListedPostVoList := _ListedPostVoList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListedPostVoList)

	if err != nil {
		return err
	}

	*o = ListedPostVoList(varListedPostVoList)

	return err
}

type NullableListedPostVoList struct {
	value *ListedPostVoList
	isSet bool
}

func (v NullableListedPostVoList) Get() *ListedPostVoList {
	return v.value
}

func (v *NullableListedPostVoList) Set(val *ListedPostVoList) {
	v.value = val
	v.isSet = true
}

func (v NullableListedPostVoList) IsSet() bool {
	return v.isSet
}

func (v *NullableListedPostVoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListedPostVoList(val *ListedPostVoList) *NullableListedPostVoList {
	return &NullableListedPostVoList{value: val, isSet: true}
}

func (v NullableListedPostVoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListedPostVoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
