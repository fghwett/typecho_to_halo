...
// checks if the LocalThumbnailList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalThumbnailList{}

// LocalThumbnailList struct for LocalThumbnailList
type LocalThumbnailList struct {
	...
	// A chunk of items.
	Items []LocalThumbnail `json:"items"`
...
type _LocalThumbnailList LocalThumbnailList
...
func (o LocalThumbnailList) MarshalJSON() ([]byte, error) {
...
func (o LocalThumbnailList) ToMap() (map[string]interface{}, error) {
...
func (o *LocalThumbnailList) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalThumbnailList := _LocalThumbnailList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLocalThumbnailList)

	if err != nil {
		return err
	}

	*o = LocalThumbnailList(varLocalThumbnailList)

	return err
}

type NullableLocalThumbnailList struct {
	value *LocalThumbnailList
	isSet bool
}

func (v NullableLocalThumbnailList) Get() *LocalThumbnailList {
	return v.value
}

func (v *NullableLocalThumbnailList) Set(val *LocalThumbnailList) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalThumbnailList) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalThumbnailList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalThumbnailList(val *LocalThumbnailList) *NullableLocalThumbnailList {
	return &NullableLocalThumbnailList{value: val, isSet: true}
}

func (v NullableLocalThumbnailList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalThumbnailList) UnmarshalJSON(src []byte) error {
	v.isSet = true
