...
// checks if the ReasonTypeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReasonTypeList{}

// ReasonTypeList struct for ReasonTypeList
type ReasonTypeList struct {
...
type _ReasonTypeList ReasonTypeList
...
func (o ReasonTypeList) MarshalJSON() ([]byte, error) {
...
func (o ReasonTypeList) ToMap() (map[string]interface{}, error) {
...
func (o *ReasonTypeList) UnmarshalJSON(data []byte) (err error) {
	...
	varReasonTypeList := _ReasonTypeList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReasonTypeList)

	if err != nil {
		return err
	}

	*o = ReasonTypeList(varReasonTypeList)

	return err
}

type NullableReasonTypeList struct {
	value *ReasonTypeList
	isSet bool
}

func (v NullableReasonTypeList) Get() *ReasonTypeList {
	return v.value
}

func (v *NullableReasonTypeList) Set(val *ReasonTypeList) {
	v.value = val
	v.isSet = true
}

func (v NullableReasonTypeList) IsSet() bool {
	return v.isSet
}

func (v *NullableReasonTypeList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReasonTypeList(val *ReasonTypeList) *NullableReasonTypeList {
	return &NullableReasonTypeList{value: val, isSet: true}
}

func (v NullableReasonTypeList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReasonTypeList) UnmarshalJSON(src []byte) error {
	v.isSet = true
