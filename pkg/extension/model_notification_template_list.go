...
type _NotificationTemplateList NotificationTemplateList
...
func (o *NotificationTemplateList) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationTemplateList := _NotificationTemplateList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotificationTemplateList)

	if err != nil {
		return err
	}

	*o = NotificationTemplateList(varNotificationTemplateList)
