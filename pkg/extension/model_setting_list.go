...
// checks if the SettingList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SettingList{}
...
func (o SettingList) ToMap() (map[string]interface{}, error) {
...
func (o *SettingList) UnmarshalJSON(data []byte) (err error) {
	...
	varSettingList := _SettingList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSettingList)

	if err != nil {
		return err
	}

	*o = SettingList(varSettingList)
