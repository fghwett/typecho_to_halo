...
// checks if the RememberMeTokenList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RememberMeTokenList{}

// RememberMeTokenList struct for RememberMeTokenList
type RememberMeTokenList struct {
	...
	// A chunk of items.
	Items []RememberMeToken `json:"items"`
...
type _RememberMeTokenList RememberMeTokenList
...
func (o RememberMeTokenList) MarshalJSON() ([]byte, error) {
...
func (o RememberMeTokenList) ToMap() (map[string]interface{}, error) {
...
func (o *RememberMeTokenList) UnmarshalJSON(data []byte) (err error) {
	...
	varRememberMeTokenList := _RememberMeTokenList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRememberMeTokenList)

	if err != nil {
		return err
	}

	*o = RememberMeTokenList(varRememberMeTokenList)

	return err
}

type NullableRememberMeTokenList struct {
	value *RememberMeTokenList
	isSet bool
}

func (v NullableRememberMeTokenList) Get() *RememberMeTokenList {
	return v.value
}

func (v *NullableRememberMeTokenList) Set(val *RememberMeTokenList) {
	v.value = val
	v.isSet = true
}

func (v NullableRememberMeTokenList) IsSet() bool {
	return v.isSet
}

func (v *NullableRememberMeTokenList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRememberMeTokenList(val *RememberMeTokenList) *NullableRememberMeTokenList {
	return &NullableRememberMeTokenList{value: val, isSet: true}
}

func (v NullableRememberMeTokenList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRememberMeTokenList) UnmarshalJSON(src []byte) error {
	v.isSet = true
