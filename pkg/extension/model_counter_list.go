...
// checks if the CounterList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CounterList{}

// CounterList struct for CounterList
...
func (o CounterList) MarshalJSON() ([]byte, error) {
...
func (o CounterList) ToMap() (map[string]interface{}, error) {
...
func (o *CounterList) UnmarshalJSON(data []byte) (err error) {
	...
	varCounterList := _CounterList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCounterList)

	if err != nil {
		return err
	}

	*o = CounterList(varCounterList)

	return err
}

type NullableCounterList struct {
	value *CounterList
	isSet bool
}

func (v NullableCounterList) Get() *CounterList {
	return v.value
}

func (v *NullableCounterList) Set(val *CounterList) {
	v.value = val
	v.isSet = true
}

func (v NullableCounterList) IsSet() bool {
	return v.isSet
}

func (v *NullableCounterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCounterList(val *CounterList) *NullableCounterList {
	return &NullableCounterList{value: val, isSet: true}
}

func (v NullableCounterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCounterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
