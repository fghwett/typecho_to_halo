...
// checks if the PersonalAccessTokenList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PersonalAccessTokenList{}

// PersonalAccessTokenList struct for PersonalAccessTokenList
...
type _PersonalAccessTokenList PersonalAccessTokenList
...
func (o PersonalAccessTokenList) MarshalJSON() ([]byte, error) {
...
func (o PersonalAccessTokenList) ToMap() (map[string]interface{}, error) {
...
func (o *PersonalAccessTokenList) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonalAccessTokenList := _PersonalAccessTokenList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonalAccessTokenList)

	if err != nil {
		return err
	}

	*o = PersonalAccessTokenList(varPersonalAccessTokenList)

	return err
}

type NullablePersonalAccessTokenList struct {
	value *PersonalAccessTokenList
	isSet bool
}

func (v NullablePersonalAccessTokenList) Get() *PersonalAccessTokenList {
	return v.value
}

func (v *NullablePersonalAccessTokenList) Set(val *PersonalAccessTokenList) {
	v.value = val
	v.isSet = true
}

func (v NullablePersonalAccessTokenList) IsSet() bool {
	return v.isSet
}

func (v *NullablePersonalAccessTokenList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePersonalAccessTokenList(val *PersonalAccessTokenList) *NullablePersonalAccessTokenList {
	return &NullablePersonalAccessTokenList{value: val, isSet: true}
}

func (v NullablePersonalAccessTokenList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePersonalAccessTokenList) UnmarshalJSON(src []byte) error {
	v.isSet = true
