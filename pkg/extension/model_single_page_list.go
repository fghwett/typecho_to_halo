...
// checks if the SinglePageList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SinglePageList{}

// SinglePageList struct for SinglePageList
type SinglePageList struct {
...
type _SinglePageList SinglePageList
...
func (o SinglePageList) MarshalJSON() ([]byte, error) {
...
func (o SinglePageList) ToMap() (map[string]interface{}, error) {
...
func (o *SinglePageList) UnmarshalJSON(data []byte) (err error) {
	...
	varSinglePageList := _SinglePageList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSinglePageList)

	if err != nil {
		return err
	}

	*o = SinglePageList(varSinglePageList)

	return err
}

type NullableSinglePageList struct {
	value *SinglePageList
	isSet bool
}

func (v NullableSinglePageList) Get() *SinglePageList {
	return v.value
}

func (v *NullableSinglePageList) Set(val *SinglePageList) {
	v.value = val
	v.isSet = true
}

func (v NullableSinglePageList) IsSet() bool {
	return v.isSet
}

func (v *NullableSinglePageList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSinglePageList(val *SinglePageList) *NullableSinglePageList {
	return &NullableSinglePageList{value: val, isSet: true}
}

func (v NullableSinglePageList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSinglePageList) UnmarshalJSON(src []byte) error {
	v.isSet = true
