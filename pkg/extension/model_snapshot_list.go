...
// SnapshotList struct for SnapshotList
...
type _SnapshotList SnapshotList
...
func (o *SnapshotList) UnmarshalJSON(data []byte) (err error) {
	...
	varSnapshotList := _SnapshotList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSnapshotList)

	if err != nil {
		return err
	}

	*o = SnapshotList(varSnapshotList)
