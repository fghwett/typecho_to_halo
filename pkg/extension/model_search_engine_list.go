...
// checks if the SearchEngineList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchEngineList{}

// SearchEngineList struct for SearchEngineList
...
type _SearchEngineList SearchEngineList
...
func (o SearchEngineList) MarshalJSON() ([]byte, error) {
...
func (o SearchEngineList) ToMap() (map[string]interface{}, error) {
...
func (o *SearchEngineList) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchEngineList := _SearchEngineList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchEngineList)

	if err != nil {
		return err
	}

	*o = SearchEngineList(varSearchEngineList)

	return err
}

type NullableSearchEngineList struct {
	value *SearchEngineList
	isSet bool
}

func (v NullableSearchEngineList) Get() *SearchEngineList {
	return v.value
}

func (v *NullableSearchEngineList) Set(val *SearchEngineList) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchEngineList) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchEngineList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchEngineList(val *SearchEngineList) *NullableSearchEngineList {
	return &NullableSearchEngineList{value: val, isSet: true}
}

func (v NullableSearchEngineList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchEngineList) UnmarshalJSON(src []byte) error {
	v.isSet = true
